...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        private static void SaveNodes(DSGraphSaveDataSO graphData, DSDialogueContainerSO dialogueContainer)
        {
            ...
            UpdateOldUngroupNodes(ungroupedNodeNames, graphData);
        }
        ...
        private static void UpdateOldGroupedNodes(SerializableDictionary<string, List<string>> currentGroupedNames, DSGraphSaveDataSO graphData)
        {
            ...
            graphData.OldGroupedNodeNames = new SerializableDictionary<string, List<string>>(currentGroupedNames);
        }
        
        private static void UpdateOldUngroupNodes(List<string> currentUngroupedNodeNames, DSGraphSaveDataSO graphData)
        {
        ...
        private static void UpdateOldGroups(List<string> currentGroupNames, DSGraphSaveDataSO graphData)
        {
            if (graphData.OldGroupNames != null && graphData.OldGroupNames.Count != 0)
            {
                ...
                {
                    RemoveFolder($"{currentGroupNames}/Groups/{groupToRemove}");
                }
            }
