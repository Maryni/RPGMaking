    ...
    public class DSInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (groupedDialoguesProperty.boolValue)
            {
                ...
                {
                    StopDrawing("No Dialogue Groups in Dialogue Container");
                    return;
                }
                ...
                dialogueInfoMessage = "No "+(currentStartingDialoguesOnlyFilter ? "Starting" : "")+" Dialogues in this Dialogue Group";
            }
            else
            {
                dialogueNames = currentDialogueContainer.GetUngroupedDialogueNames(currentStartingDialoguesOnlyFilter);
                dialogueFolderPath += "/Global/Dialogues";
                dialogueInfoMessage = "No "+(currentStartingDialoguesOnlyFilter ? "Starting" : "")+" Ungrouped Dialogues in this Dialogue Container";
            }
        ...
        private void DrawDialogueArea(List<string> dialogueNames, string dialogueFolderPath)
        {
            ...
            DSInspectorUtility.DrawPopup("Dialogue", selectedDialogueIndexProperty.intValue, dialogueNames.ToArray());
